...
namespace MyEngine
{
    public class Shader : IUnloadable
    {
        ...
        Resource resource;
        internal Shader(Resource resource)
        {
            Load(resource);
        ...
        void StartWatcher(Resource resource)
        {
            try
            {
        ...
        internal void Load(Resource resource)
        {
            StopAllWatchers();
            ...
            Resource prependAllRes = "internal/prependAll.shader";
            string prependAll = "";
            numOfRetries = 5;
            while (numOfRetries > 0)
            {
